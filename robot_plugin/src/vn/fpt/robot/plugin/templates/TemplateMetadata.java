...
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_MIN_API;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_MIN_BUILD_API;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_REVISION;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_BACKGROUND;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_CLIPART_NAME;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_DESCRIPTION;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_FOREGROUND;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_FORMAT;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_NAME;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_PADDING;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_SHAPE;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_SOURCE_TYPE;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_TEXT;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_TRIM;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_TYPE;
import static vn.fpt.robot.plugin.templates.TemplateHandler.CURRENT_FORMAT;
import static vn.fpt.robot.plugin.templates.TemplateHandler.TAG_DEPENDENCY;
import static vn.fpt.robot.plugin.templates.TemplateHandler.TAG_ICONS;
import static vn.fpt.robot.plugin.templates.TemplateHandler.TAG_PARAMETER;
import static vn.fpt.robot.plugin.templates.TemplateHandler.TAG_THUMB;
