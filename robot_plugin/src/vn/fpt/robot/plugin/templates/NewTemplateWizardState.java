...
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_BUILD_API;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_COPY_ICONS;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_MIN_API;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_MIN_API_LEVEL;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_PACKAGE_NAME;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.ATTR_TARGET_API;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.IS_LIBRARY_PROJECT;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.IS_NEW_PROJECT;
import static vn.fpt.robot.plugin.templates.NewTemplateWizard.BLANK_ACTIVITY;
