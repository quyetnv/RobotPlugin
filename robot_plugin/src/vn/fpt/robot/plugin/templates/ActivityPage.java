...
import static vn.fpt.robot.plugin.templates.NewProjectWizard.CATEGORY_ACTIVITIES;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.CATEGORY_OTHER;
import static vn.fpt.robot.plugin.templates.NewProjectWizard.IS_LAUNCHER;
...
import vn.fpt.robot.plugin.preferences.PrefUtils;
...
//        java.util.List<File> templates = manager.getTemplates(CATEGORY_ACTIVITIES);
        java.util.List<File> templates = manager.getTemplates(PrefUtils.getRobotSDKLocation(),CATEGORY_ACTIVITIES);
        if (!mOnlyActivities) {
