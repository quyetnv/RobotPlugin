...
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_DEFAULT;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_ID;
import static vn.fpt.robot.plugin.templates.TemplateHandler.ATTR_NAME;
import static vn.fpt.robot.plugin.templates.TemplateHandler.PREVIEW_PADDING;
import static vn.fpt.robot.plugin.templates.TemplateHandler.PREVIEW_WIDTH;
...
import vn.fpt.robot.plugin.templates.Parameter.Constraint;
import vn.fpt.robot.plugin.templates.Parameter.Type;
        ...
        if (status == null || status.isOK()) {
            if (mChooseProject && mValues.project == null) {
                status = new Status(IStatus.ERROR, AdtPlugin.PLUGIN_ID,
                        "Please select an Robot project.");
            }
        }
